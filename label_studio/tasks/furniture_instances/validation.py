...
from tasks.occupancy.validation import (
    OPTIONAL_REFERENCES as L2_OPTIONAL_REFERENCE_CONTROLS,
    REQUIRED_REFERENCES as L2_REQUIRED_REFERENCE_CONTROLS,
)
from tasks.occupancy.validation import (
...
REQUIRED_REFERENCE_CONTROLS = (
    L2_REQUIRED_REFERENCE_CONTROLS
    | GROUP_GEOMETRY_CONTROLS
    | {OCCUPANCY_TYPE_CONTROL}
)
OPTIONAL_REFERENCE_CONTROLS = L2_OPTIONAL_REFERENCE_CONTROLS | {BARRIER_CONTROL}
REFERENCE_CONTROLS = REQUIRED_REFERENCE_CONTROLS | OPTIONAL_REFERENCE_CONTROLS
ROLE_BY_CONTROL = {
